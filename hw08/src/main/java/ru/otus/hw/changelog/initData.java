...
public class initData {
    ...
    public void initComments(CommentRepository repository) {
        ...
        comments.add(new Comment(String.valueOf(1), books.get(0), "Comment_1_1" , LocalDate.of(2024, 1, 1), "Author_1"));
        comments.add(new Comment(String.valueOf(2), books.get(1), "Comment_2" , LocalDate.of(2024, 1, 2), "Author_2"));
        comments.add(new Comment(String.valueOf(3), books.get(2), "Comment_3" , LocalDate.of(2024, 1, 3), "Author_3"));
        comments.add(new Comment(String.valueOf(4), books.get(0), "Comment_1_2" , LocalDate.of(2024, 1, 4), "Author_1"));
        comments.add(new Comment(String.valueOf(5), books.get(0), "Comment_1_3" , LocalDate.of(2024, 1, 4), "Author_2"));
